        ...
        <Grid container className="title-wrapper">
          <Grid item xs={6}>
            <Typography variant="h2">
              Total Books
              <span> - {bookList.totalRecords} </span>
            </Typography>
          </Grid>
                ...
                <div className="product-list-inner">
                  ...
                  <div className="content-wrapper">
                    ...
                    <div className="price-btn-wrapper">
                      ...
                      <button className="MuiButtonBase-root plus-btn MuiButton-root MuiButton-contained btn pink-btn MuiButton-containedPrimary MuiButton-disableElevation">
                        <span
